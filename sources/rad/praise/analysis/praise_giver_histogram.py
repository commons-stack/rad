...
def run(praise_distribution_data, _config={}):
    ...
    res = praise_distribution_data.praiseInstance.get_praise_by_giver()
...
def printDescription(praise_distribution_data, _config={}):
    ...
    description = f"TODO Praise giver hist text"

    # display(Markdown(header))
    display(Markdown(description))


def printGraph(praise_distribution_data, _config={"x":"FROM USER ACCOUNT", "y":["POINTS GIVEN"]}):
    """
    ...
    fig_freq = px.bar(distribution, x=x_row, y=y_rows)
    fig_freq.show()
